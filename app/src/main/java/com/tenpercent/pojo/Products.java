...
public class Products implements Parcelable {
    ...
    public @Ignore Products(Integer id, String name, String desc, String image, Integer categoryId,
                    Integer sellerId, Integer orderCount, Integer rate, Integer price, Integer discount) {
        this.id = id;
        this.name = name;
        this.desc = desc;
        this.image = image;
